...
class UtilisateurReponsesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.utilisateurReponses.index', compact('utilisateurReponses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.utilisateurReponses.create', compact('reponses', 'utilisateurs'));
    }
    ...
    public function store(StoreUtilisateurReponseRequest $request)
    {
        ...
        return redirect()->route('admin.utilisateur-reponses.index');
    }
    ...
    public function edit(UtilisateurReponse $utilisateurReponse)
    {
        ...
        return view('admin.utilisateurReponses.edit', compact('reponses', 'utilisateurReponse', 'utilisateurs'));
    }
    ...
    public function show(UtilisateurReponse $utilisateurReponse)
    {
        ...
        return view('admin.utilisateurReponses.show', compact('utilisateurReponse'));
    }
