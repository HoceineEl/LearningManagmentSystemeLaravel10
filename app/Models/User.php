...
class User extends Authenticatable
{
    ...
    public function utilisateurUtilisateurReponses()
    {
        return $this->hasMany(UtilisateurReponse::class, 'utilisateur_id', 'id');
    }

    public function utilisateurScoreQuizzes()
    {
        return $this->hasMany(ScoreQuiz::class, 'utilisateur_id', 'id');
    }

    public function utilisateurProgressions()
    {
        return $this->hasMany(Progression::class, 'utilisateur_id', 'id');
    }

    public function utilisateurCommentaires()
    {
        return $this->hasMany(Commentaire::class, 'utilisateur_id', 'id');
    }
