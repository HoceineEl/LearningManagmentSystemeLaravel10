<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('cour_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.cours.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/cours") || request()->is("admin/cours/*") ? "c-active" : "" }}">
        ...
        @can('quiz_question_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.quiz-questions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/quiz-questions") || request()->is("admin/quiz-questions/*") ? "c-active" : "" }}">
        ...
        @can('question_reponse_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.question-reponses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/question-reponses") || request()->is("admin/question-reponses/*") ? "c-active" : "" }}">
        ...
        @can('utilisateur_reponse_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.utilisateur-reponses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/utilisateur-reponses") || request()->is("admin/utilisateur-reponses/*") ? "c-active" : "" }}">
        ...
        @can('score_quiz_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.score-quizzes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/score-quizzes") || request()->is("admin/score-quizzes/*") ? "c-active" : "" }}">
        ...
        @can('progression_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.progressions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/progressions") || request()->is("admin/progressions/*") ? "c-active" : "" }}">
        ...
        @can('commentaire_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.commentaires.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/commentaires") || request()->is("admin/commentaires/*") ? "c-active" : "" }}">
        ...
        @can('contenu_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.contenus.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/contenus") || request()->is("admin/contenus/*") ? "c-active" : "" }}">
