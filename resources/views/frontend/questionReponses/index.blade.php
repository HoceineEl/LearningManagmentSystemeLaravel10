        ...
        <div class="col-md-12">
            @can('question_reponse_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.question-reponses.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-QuestionReponse">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $questionReponse->id }}">
                                        ...
                                        <td>
                                            @can('question_reponse_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.question-reponses.show', $questionReponse->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('question_reponse_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.question-reponses.edit', $questionReponse->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('question_reponse_delete')
                                                <form action="{{ route('frontend.question-reponses.destroy', $questionReponse->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('question_reponse_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.question-reponses.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-QuestionReponse:not(.ajaxTable)').DataTable({ buttons: dtButtons })
