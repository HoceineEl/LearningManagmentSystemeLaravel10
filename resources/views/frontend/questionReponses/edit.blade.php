    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.question-reponses.update", [$questionReponse->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reponse" id="reponse" value="{{ old('reponse', $questionReponse->reponse) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="est_correct" id="est_correct" value="1" {{ $questionReponse->est_correct || old('est_correct', 0) === 1 ? 'checked' : '' }}>
