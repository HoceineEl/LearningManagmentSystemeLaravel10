                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sections.update", [$section->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="label" id="label" value="{{ old('label', $section->label) }}" required>
                            @if($errors->has('label'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="cours_id" id="cours_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="position" id="position" value="{{ old('position', $section->position) }}" step="1" required>
