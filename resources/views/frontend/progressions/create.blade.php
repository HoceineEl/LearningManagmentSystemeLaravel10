    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.progressions.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="est_complete" id="est_complete" value="1" {{ old('est_complete', 0) == 1 ? 'checked' : '' }}>
