        ...
        <div class="card-body">
            <form method="POST" action="{{ url('admin/question-reponses/store/' . $questions->id) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reponse') ? 'is-invalid' : '' }}" type="text"
                        name="reponse" id="reponse" value="{{ old('reponse', '') }}" required>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('est_correct') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="est_correct" id="est_correct" value="1"
                            {{ old('est_correct', 0) == 1 ? 'checked' : '' }}>
                        <label class="form-check-label"
                            for="est_correct">{{ trans('cruds.questionReponse.fields.est_correct') }}</label>
                    </div>
