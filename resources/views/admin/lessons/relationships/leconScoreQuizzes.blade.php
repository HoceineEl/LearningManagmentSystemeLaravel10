...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-lessonScoreQuizzes">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.scoreQuiz.fields.lesson') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-lessonScoreQuizzes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
