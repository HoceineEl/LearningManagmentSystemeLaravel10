                ...
                <li class="section" data-section-name="{{ $section->label }}" data-section-id="{{ $section->id }}">
                    <div class="d-flex justify-content-between header">
                        ...
                        <div class="dropDown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="padding: 0%">
                                <li><button type="button" class="btn btn-primary dropdown-item edit-section">Edit</button></li>
                                <li><button type="button" class="btn btn-danger dropdown-item"
                                        data-bs-toggle="modal" data-bs-target="#deleteSection{{$section->id}}">
                                        Supprimer
                                    </button></li>
                        ...
                        <div class="modal fade" id="deleteSection{{$section->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                    ...
                    <ul class="lesson-list" data-section-id="{{ $section->id }}">
                        ...
                        <li class="lesson d-flex justify-content-between" data-lesson-id="{{ $lesson->id }}"
                            ...
                            <div class="dropDownL">
                                <span id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa fa-ellipsis-v info"></i></span>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="padding: 0%">
                                    <li><button type="button" class="btn btn-primary dropdown-item edit-lesson">Edit</button></li>
